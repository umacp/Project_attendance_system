<?php
include_once '../components/_partials/header.php';
...
<div class="flex gap-5 flex-wrap items-center justify-center px-10">
<a
  class="relative flex items-start justify-between rounded-xl border border-gray-100 p-4 shadow-xl sm:p-6 lg:p-8 max-w-[400px]"
  href="#"
  >
